# Некоммерческий шаблон магазина одежды в рамках самообразования

**При верстке шаблона использован компонентный подход. Все компоненты собираются посредством [webpack](https://webpack.js.org/)**.

***Посмотреть живое [демо](https://encrypticus.github.io/aditu/).***

***Чтобы скопировать репозиторий на свой компьютер, в консоли наберите ```git clone https://github.com/encrypticus/aditu.git```***
